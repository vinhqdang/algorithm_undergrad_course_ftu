...
After completing the problems above, practise this week's asymptotic-analysis and
binary-search techniques on the following \href{https://leetcode.com}{LeetCode} problems.
Difficulty is LeetCode's own label.

\begin{itemize}
  \item \href{https://leetcode.com/problems/search-insert-position/}{Search Insert Position} -- \emph{Easy} -- binary search.
  \item \href{https://leetcode.com/problems/first-bad-version/}{First Bad Version} -- \emph{Easy} -- binary search on answer.
  \item \href{https://leetcode.com/problems/sqrtx/}{Sqrt(x)} -- \emph{Easy} -- binary search.
  \item \href{https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/}{Find First and Last Position of Element in Sorted Array} -- \emph{Medium} -- binary search (bounds).
  \item \href{https://leetcode.com/problems/search-in-rotated-sorted-array/}{Search in Rotated Sorted Array} -- \emph{Medium} -- binary search.
  \item \href{https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/}{Find Minimum in Rotated Sorted Array} -- \emph{Medium} -- binary search.
  \item \href{https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/}{Two Sum II - Input Array Is Sorted} -- \emph{Medium} -- two pointers.
  \item \href{https://leetcode.com/problems/majority-element/}{Majority Element} -- \emph{Easy} -- Boyer--Moore/counting.
\end{itemize}
