...
After completing the problems above, practise this week's graph traversal (BFS/DFS),
topological-sort, and union-find techniques on the following
\href{https://leetcode.com}{LeetCode} problems. Difficulty is LeetCode's own label.

\begin{itemize}
  \item \href{https://leetcode.com/problems/number-of-islands/}{Number of Islands} -- \emph{Medium} -- BFS/DFS.
  \item \href{https://leetcode.com/problems/clone-graph/}{Clone Graph} -- \emph{Medium} -- BFS/DFS.
  \item \href{https://leetcode.com/problems/rotting-oranges/}{Rotting Oranges} -- \emph{Medium} -- multi-source BFS.
  \item \href{https://leetcode.com/problems/course-schedule/}{Course Schedule} -- \emph{Medium} -- topological sort.
  \item \href{https://leetcode.com/problems/course-schedule-ii/}{Course Schedule II} -- \emph{Medium} -- topological sort.
  \item \href{https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/}{Number of Connected Components in an Undirected Graph} -- \emph{Medium} -- union-find.
  \item \href{https://leetcode.com/problems/graph-valid-tree/}{Graph Valid Tree} -- \emph{Medium} -- union-find.
  \item \href{https://leetcode.com/problems/redundant-connection/}{Redundant Connection} -- \emph{Medium} -- union-find.
  \item \href{https://leetcode.com/problems/accounts-merge/}{Accounts Merge} -- \emph{Medium} -- union-find.
  \item \href{https://leetcode.com/problems/pacific-atlantic-water-flow/}{Pacific Atlantic Water Flow} -- \emph{Medium} -- DFS/BFS.
\end{itemize}
