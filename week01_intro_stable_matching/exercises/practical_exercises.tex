...
After completing the problems above, reinforce this week's data structures and warm-up
techniques on the following \href{https://leetcode.com}{LeetCode} problems (stable matching
itself is not on LeetCode, so these drill the supporting tools: stacks, queues, heaps,
linked lists, binary search, and recursion). Difficulty is LeetCode's own label.

\begin{itemize}
  \item \href{https://leetcode.com/problems/valid-parentheses/}{Valid Parentheses} -- \emph{Easy} -- stack.
  \item \href{https://leetcode.com/problems/min-stack/}{Min Stack} -- \emph{Medium} -- stack.
  \item \href{https://leetcode.com/problems/implement-queue-using-stacks/}{Implement Queue using Stacks} -- \emph{Easy} -- stack/queue.
  \item \href{https://leetcode.com/problems/reverse-linked-list/}{Reverse Linked List} -- \emph{Easy} -- linked list.
  \item \href{https://leetcode.com/problems/binary-search/}{Binary Search} -- \emph{Easy} -- binary search.
  \item \href{https://leetcode.com/problems/fibonacci-number/}{Fibonacci Number} -- \emph{Easy} -- recursion/memoization.
  \item \href{https://leetcode.com/problems/kth-largest-element-in-a-stream/}{Kth Largest Element in a Stream} -- \emph{Easy} -- binary heap.
  \item \href{https://leetcode.com/problems/sort-an-array/}{Sort an Array} -- \emph{Medium} -- heapsort/sorting.
\end{itemize}
